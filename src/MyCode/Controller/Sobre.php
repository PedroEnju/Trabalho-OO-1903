...
class Sobre
{
    ...
    {
        $p = "Site é um sistema feito orientado a objetos utilizando componentes já existentes de uma framework chamada Symfony. Utilizando rotas como por exemplo /produto. Uma rota que chama uma função de um controller que retorna a requisição, sendo renderizado utilizando twig.";
        return $p;
    }
